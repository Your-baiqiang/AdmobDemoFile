...
// 添加处理广告点击事件的代码
//    let interAd = nativeAd
//    interAd.paidEventHandler = { adValue in
//      let params = [AppEvents.ParameterName.currency: adValue.currencyCode]
//      AppEvents.shared.logEvent(AppEvents.Name.purchased, valueToSum: Double(truncating: adValue.value), parameters: params)
//    }
